var DiscSimulator = DiscSimulator || {
  ...
  Vector: function(x, y, startx, starty) {
    ...
    this.normalVector = function() {
      return new DiscSimulator.Vector(this.y, -this.x);
    };
  },

  createDisc: function(x, y, radius) {
  ...
  createArm: function(x, y, width, length) {
  ...
  intersection: function(circle1, circle2) {
  ...
  calulateArmArcIntersections: function(x, y) {
  ...
  drawIntersections: function(pts) {
  ...
  xMove: document.getElementById("xValue"),
  yMove: document.getElementById("yValue"),
